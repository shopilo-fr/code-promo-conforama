#!/usr/bin/env python3
"""
Recuperation des codes promo Conforama depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/conforama.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/conforama.fr"
STORE_NAME = "Conforama"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Conforama depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-conforama)"
    }
    try:
